...
export const messages: Record<Locale, MessageDictionary> = {
  'zh-CN': {
    ...
    sidebar: {
      ...
      searchLoadingTitle: '正在搜索',
      searchLoadingDescription: '正在当前身份下的对话中查找相关内容。',
      searchEmptyTitle: '没有找到相关内容',
      searchEmptyDescription: '试试更短或更明确的关键词。',
      searchErrorTitle: '搜索失败',
      searchErrorDescription: '暂时无法搜索对话内容，请稍后再试。',
      emptyTitle: '还没有历史对话',
  ...
  ja: {
    ...
    sidebar: {
      ...
      searchLoadingTitle: '検索中',
      searchLoadingDescription: '現在のユーザー範囲で会話内容を検索しています。',
      searchEmptyTitle: '関連する内容が見つかりませんでした',
      searchEmptyDescription: 'より短いキーワード、または別の表現で試してください。',
      searchErrorTitle: '検索に失敗しました',
      searchErrorDescription:
        '現在会話内容を検索できません。しばらくしてから再度お試しください。',
